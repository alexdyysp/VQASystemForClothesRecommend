...
public class WebIATWS extends WebSocketListener {
    ...
    //private static final String hostUrl = "https://dz-xf-japanese.xf-yun.com/msp.do";
    ...
    /*private static final String apiKey = "d6b4781a77e8ee279348519e5a17bb3f";
    private static final String apiSecret = "ZDZiNDc4MWE3N2U4ZWUyNzkzNDg1MTllNWExN2JiM2Z4Znl1bmNvbnNvbGU=";
    private static final String appid = "5bfba611";*/
    //private static final String file = "resource\\iat\\out_xw.ogg"; // 中文ogg
    private static final String file = "resource\\iat\\16k_10_zhen.pcm"; // 中文pcm
    //private static final String file = "resource\\iat\\ja\\16k_ja.pcm"; // 日语
                ...
                while (true) {
                    ...
                    switch (status) {
                        case StatusFirstFrame:   // 第一帧音频status = 0
                            ...
                            //fa_nbest=true、fa_sch=true
                            //business.addProperty("nunum", 0);//1:阿拉伯，默认为1
                            //business.addProperty("ptt", 0);//标点符号 1：开启（默认值），0：关闭，日语不支持
                            ...
                            //data.addProperty("encoding", "opus-ogg");
                        ...
                        case StatusContinueFrame:  //中间帧status = 1
                            ...
                            //data1.addProperty("encoding", "opus-ogg");
                        ...
                        case StatusLastFrame:    // 最后一帧音频status = 2 ，标志音频发送结束
                            ...
                            //data2.addProperty("encoding", "opus-ogg");
